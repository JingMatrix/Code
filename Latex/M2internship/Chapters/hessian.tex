...
For a compact set $K \subset M$ and a positive integrable function $l: K \rightarrow \mathbb{R}$,
...
\begin{proof}
	% Write $\mathbb{P} = \eta\, \mathbb{P}_1 + (1 - \eta)\, \mathbb{P}_2$ with
	% $\eta := \mathbb{P}(\mathcal{A}_{K,l})$ and $\mathbb{P}_1$ the
	% restriction measure of $\mathbb{P}$ to the measurable set $\mathcal{A}_{K,l}$.
